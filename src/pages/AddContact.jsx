  ...
  return (
    <div className='container-fluid text-center mt-5'>
      ...
      <div className='bg-white w-50 mx-auto rounded shadow'>
        <form className='mt-5 d-flex flex-column p-3'>
          ...
          <input className='form-control mb-4' type="mail" value={email} placeholder='Introduce Email' onChange={(e)=>setName(e.target.value)}/>

          <label className='form-label d-flex justify-content-start mb-2'>Phone</label>
          <input className='form-control mb-4' type="text" value={tlf} placeholder='Introduce Phone' onChange={(e)=>setName(e.target.value)}/>

          <label className='form-label d-flex justify-content-start mb-2'>Address</label>
          <input className='form-control mb-4' type="text" value={address} placeholder='Introduce Address' onChange={(e)=>setName(e.target.value)}/>
